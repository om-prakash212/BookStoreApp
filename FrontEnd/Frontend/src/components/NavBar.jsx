        ...
        <div className="max-w-screen-2xl container mx-auto px-5 md:px-20">
          <div className="navbar">
            <div className="navbar-start">
              ...
              <Link to="/" className="text-3xl font-bold cursor-pointer px-10">ପୁସ୍ତକମ୍</Link>
            </div>
            <div className="navbar-end">
              ...
              <div className="hidden md:block">
                <label className="px-2 py-3 border rounded-md outline-none flex items-center gap-2 ">
              ...
              <button
                className="bg-slate-900  ml-4 text-white p-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer dark:bg-pink-500 dark:text-white dark:hover:bg-pink-800 dark:hover:text-white"
